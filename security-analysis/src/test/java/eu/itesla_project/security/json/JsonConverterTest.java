...
public class JsonConverterTest {
    ...
    public void setUp() throws JsonParseException, JsonMappingException, IOException {
        ...
        LimitViolation violation1 = new LimitViolation(line1, LimitViolationType.CURRENT, 100f, "limit", .95f, 110f, Country.FR, 380f);
        LimitViolation violation2 = new LimitViolation(line2, LimitViolationType.CURRENT, 100f, null, 110f);
        ...
        jsonResult = "{\"preContingencyResult\":{\"computationOk\":true,\"limitViolations\":[{\"subject\":\"NHV1_NHV2_1\",\"limitType\":\"CURRENT\"," + 
                     ...
                     "\"type\":\"GENERATOR\"}]},\"computationOk\":true,\"limitViolations\":[{\"subject\":\"NHV1_NHV2_1\",\"limitType\":\"CURRENT\"," + 
                     "\"limit\":100.0,\"limitName\":\"limit\",\"limitReduction\":0.95,\"value\":110.0,\"country\":\"FR\",\"baseVoltage\":380.0}," + 
                     "{\"subject\":\"NHV1_NHV2_2\",\"limitType\":\"CURRENT\",\"limit\":100.0,\"limitName\":null,\"limitReduction\":1.0,\"value\":110.0," + 
