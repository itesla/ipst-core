...
public class TableFormatterTest {
    ...
    public void testCsv() throws IOException {
        ...
        try (TableFormatter formatter = new CsvTableFormatter(new OutputStreamWriter(bos, StandardCharsets.UTF_8), "csv test", config, COLUMNS)) {
            write(formatter);
        }
    ...
    public void testAcsii() throws IOException {
        ...
        try (TableFormatter formatter = new AsciiTableFormatter(new OutputStreamWriter(bos, StandardCharsets.UTF_8), "ascii test", config, COLUMNS)) {
            write(formatter);
        }
        assertEquals(new String(bos.toByteArray(), StandardCharsets.UTF_8),
                "ascii test:\n" +
