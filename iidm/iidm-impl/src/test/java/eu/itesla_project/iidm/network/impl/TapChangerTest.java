...
public class TapChangerTest {
    ...
    public void baseTestsPhaseTapChanger() {
        ...
        PhaseTapChanger phaseTapChanger = twt.newPhaseTapChanger()
                                                .setTapPosition(1).setLowTapPosition(0)
                                                .setRegulating(true).setRegulationMode(PhaseTapChanger.RegulationMode.ACTIVE_POWER_CONTROL)
                                                .setRegulationValue(10.0f).setRegulationTerminal(terminal)
                                                    .beginStep().setR(1.0f).setX(2.0f).setG(3.0f).setB(4.0f).setAlpha(5.0f).setRho(6.0f).endStep()
                                                    .beginStep().setR(1.0f).setX(2.0f).setG(3.0f).setB(4.0f).setAlpha(5.0f).setRho(6.0f).endStep()
                                            .add();
    ...
    private void createPhaseTapChangerWith2Steps(int tapPosition, int lowTap, boolean isRegulating,
        ...
        twt.newPhaseTapChanger()
                .setTapPosition(tapPosition).setLowTapPosition(lowTap)
                .setRegulating(isRegulating).setRegulationMode(mode)
                .setRegulationValue(value).setRegulationTerminal(terminal)
                    .beginStep().setR(1.0f).setX(2.0f).setG(3.0f).setB(4.0f).setAlpha(5.0f).setRho(6.0f).endStep()
                    .beginStep().setR(1.0f).setX(2.0f).setG(3.0f).setB(4.0f).setAlpha(5.0f).setRho(6.0f).endStep()
            .add();
    }
