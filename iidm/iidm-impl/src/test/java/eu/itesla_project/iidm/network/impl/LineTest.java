...
public class LineTest {
    ...
    public void baseAcLineTests() {
        ...
        Line acLine = network.newLine()
                                .setId("line").setName("lineName")
                                .setR(1.0f).setX(2.0f)
                                .setG1(3.0f).setG2(3.5f)
                                .setB1(4.0f).setB2(4.5f)
                                .setVoltageLevel1("vl1").setVoltageLevel2("vl2")
                                .setBus1("busA").setBus2("busB")
                                .setConnectableBus1("busA").setConnectableBus2("busB")
                            .add();
    ...
    private void createTieLineWithHalfline2ByDefault(String id, String name, String halfLineId, float r, float x,
        ...
        network.newTieLine().setId(id).setName(name)
                    .line1()
                        .setId(halfLineId).setName("half1_name")
                        .setR(r).setX(x).setB1(b1).setB2(b2).setG1(g1).setG2(g2)
                        .setXnodeQ(xnodeQ).setXnodeP(xnodeP)
                    .line2()
                        .setId("hl2").setName("half2_name")
                        .setR(1.0f).setX(2.0f).setB1(3.0f).setB2(3.5f).setG1(4.0f).setG2(4.5f)
                        .setXnodeP(5.0f).setXnodeQ(6.0f)
                    .setVoltageLevel1("vl1")
                    .setBus1("busA").setConnectableBus1("busA")
                    .setVoltageLevel2("vl2")
                    .setBus2("busB").setConnectableBus2("busB")
