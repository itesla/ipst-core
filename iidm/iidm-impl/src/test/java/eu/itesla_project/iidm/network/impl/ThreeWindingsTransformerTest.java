...
public class ThreeWindingsTransformerTest {
    ...
    public void baseTests() {
        ThreeWindingsTransformer transformer = substation.newThreeWindingsTransformer()
                .setId("twt")
                .setName("twtName")
                    .newLeg1().setR(1.3f).setX(1.4f)
                        .setG(1.6f).setB(1.7f).setRatedU(1.1f)
                        .setVoltageLevel("vl1").setConnectableBus("busA").setBus("busA")
                    .add()
                    .newLeg2().setR(2.03f).setX(2.04f).setRatedU(2.05f)
                        .setVoltageLevel("vl2").setConnectableBus("busB")
                    .add()
    ...
    private void createThreeWindingsTransformerWithLeg1(float r, float x, float g, float b, float ratedU) {
        substation.newThreeWindingsTransformer()
                .setId("twt")
                .setName("twtName")
                    .newLeg1().setR(r).setX(x)
                        .setG(g).setB(b).setRatedU(ratedU)
                        .setVoltageLevel("vl1").setConnectableBus("busA")
                    .add()
                    .newLeg2().setR(2.03f).setX(2.04f).setRatedU(2.05f)
                        .setVoltageLevel("vl2").setConnectableBus("busB")
                    .add()
